...
class LDAPConnection {
  ...
  Future<LDAPConnection> connect() {
    ...
    _cmgr.connect().then((cx) {
      ...
      ldapLogger.severe("Connect error ${e}");
      c.completeError(e);
    });
    return c.future;
  }
  ...
  Future<LDAPResult> modifyPassword(String dn, String oldPassword, String newPassword) =>
      _cmgr.process(new ModifyPasswordRequest(dn, oldPassword, newPassword));
