...
//  static const SERVER_SIDE_SORT_RESPONSE = "1.2.840.113556.1.4.474";
  ...
  static const CONTROLS_TAG = 0xA0;

  // seq encoding for controls

  bool isCritical = false;

  // true if this control is critical (the server must implement)
  ...
  static List<Control> parseControls(ASN1Sequence obj) {
    ldapLogger.finest("Create Controls from $obj");
  ...
  static _parseControl(ASN1Sequence s) {
    ...
    ldapLogger.finest("Got control $oid");
    switch (oid) {
